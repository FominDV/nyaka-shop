...
//    @Mapping(target = "category", expression = "java(getCategoryTitle(source))")
...
//    }
//
//    protected String getCategoryTitle(Product source){
//        return source.getCategories().get(0).getTitle();
//    }
//
//}
